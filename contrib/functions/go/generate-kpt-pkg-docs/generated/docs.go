...
var GenerateKptPkgDocsShort = `The ` + "`" + `generate-kpt-pkg-docs` + "`" + ` function generates opinionated documentation for a [blueprint kpt package](https://github.com/GoogleCloudPlatform/blueprints).

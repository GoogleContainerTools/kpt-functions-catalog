...
var GenerateBlueprintDocsShort = `The ` + "`" + `generate-blueprint-docs` + "`" + ` function generates opinionated documentation for a [blueprint](https://github.com/GoogleCloudPlatform/blueprints).

It works by analyzing a blueprint kpt package to generate markdown documentation and writes it to a file.`
var GenerateBlueprintDocsLong = `
## Usage

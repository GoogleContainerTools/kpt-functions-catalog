...
```shell
$ kpt pkg get https://github.com/GoogleContainerTools/kpt-functions-catalog.git/examples/kubeval-mount-schema@kubeval/v0.3.0
```
...
```shell
$ kpt fn eval kubeval-mount-schema -i gcr.io/kpt-fn/kubeval:v0.3.0 --results-dir /tmp \

...
```shell
$ kpt pkg get https://github.com/GoogleContainerTools/kpt-functions-catalog.git/examples/kubeval-imperative@kubeval/v0.3.0
```
...
$ kpt fn eval kubeval-imperative --image gcr.io/kpt-fn/kubeval:v0.3.0 --results-dir /tmp -- strict=true skip_kinds=MyCustom,MyOtherCustom
```
...
[`kubeval`]: https://catalog.kpt.dev/kubeval/v0.3/

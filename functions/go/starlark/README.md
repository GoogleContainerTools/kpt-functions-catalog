...
```shell
$ kpt fn eval --image gcr.io/kpt-fn/starlark:v0.3 -- source="$(cat main.star)" param1=value1 param2=value2
```
...
```shell
$ kpt fn eval --image gcr.io/kpt-fn/starlark:v0.3 --fn-config fn-config.yaml
```

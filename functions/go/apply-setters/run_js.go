...
func applySetters(input []byte) ([]byte, error) {
	return fn.Run(fn.ResourceListProcessorFunc(applysetters.ApplySetters), []byte(input))
}
...
func resourceListProcessorWrapper() js.Func {
	...
	jsonFunc := js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		input := args[0].String()
		applied, err := applySetters([]byte(input))
		if err != nil {

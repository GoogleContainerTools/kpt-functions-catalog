...
import (
	...
	v1 "github.com/GoogleContainerTools/kpt-functions-catalog/functions/go/native-config-adaptor/api/kptfile/v1"
	"github.com/GoogleContainerTools/kpt-functions-catalog/functions/go/native-config-adaptor/fn/internal"
...
func (o *SubObject) SetSlice(objects SliceSubObjects, field string) error {
	return o.SetNestedField(objects, field)
}

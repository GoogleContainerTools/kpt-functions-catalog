...
const (
	...
	// e.g. ConfigMap Generator should be the functionConfig GKNN in the form of <GROUP>|<KIND>|<NAMESPACE>|<NAME>
	GeneratorIdentifier        = KptUseOnlyPrefix + "generator"
	GeneratorBuiltinIdentifier = KptUseOnlyPrefix + "generator-builtin-only"
)

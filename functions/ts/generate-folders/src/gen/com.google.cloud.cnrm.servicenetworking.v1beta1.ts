export type ServiceNetworkingConnection = object;

// ServiceNetworkingConnectionList is a list of ServiceNetworkingConnection
export class ServiceNetworkingConnectionList {
  ...
  public items: ServiceNetworkingConnection[];

  // Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
  public kind: string;

  // ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  public metadata?: ServiceNetworkingConnectionList.Metadata;

  constructor(desc: ServiceNetworkingConnectionList) {
...
export namespace ServiceNetworkingConnectionList {
  ...
  export interface Interface {
    // List of servicenetworkingconnections. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    items: ServiceNetworkingConnection[];

    // ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
    metadata?: ServiceNetworkingConnectionList.Metadata;
  }
  // ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.

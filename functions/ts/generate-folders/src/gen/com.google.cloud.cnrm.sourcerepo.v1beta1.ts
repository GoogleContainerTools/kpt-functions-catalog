export type SourceRepoRepository = object;

// SourceRepoRepositoryList is a list of SourceRepoRepository
export class SourceRepoRepositoryList {
  ...
  public items: SourceRepoRepository[];

  // Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
  public kind: string;

  // ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  public metadata?: SourceRepoRepositoryList.Metadata;

  constructor(desc: SourceRepoRepositoryList) {
...
export namespace SourceRepoRepositoryList {
  ...
  export interface Interface {
    // List of sourcereporepositories. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    items: SourceRepoRepository[];

    // ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
    metadata?: SourceRepoRepositoryList.Metadata;
  }
  // ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
